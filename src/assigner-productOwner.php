...
class ScrumMasterAssignment
{
    ...
    public function __construct($connection)
    {
        ...
        if (isset($_POST["submit"])) {
            $this->assignScrumMasterToProject();
        }
    ...
    private function assignScrumMasterToProject()
    {
                        ...
                        <div class="col col-xl-10">
                            <div class="card" style="border-radius: 1rem;">
                                ...
                                <div class="row g-0">
                                    ...
                                    $queryProjects = mysqli_query($this->conn, "SELECT id_projets, nom_projet FROM projets ;");
                                    ...
                                    ?>
                                                ...
                                                <select class="form-select" aria-label="Default select example"
                                                    name="scrumMaster">
                                                    <?php
                                    $queryScrumMasters = mysqli_query($this->conn, "SELECT id_user, Last_name FROM users WHERE role = 'scrum_master'");
