                            ...
                            foreach ($projects as $projet) {
                                ...
                                <tbody class="table-light">
                                    <tr>
                                        ...
                                        <td><a href="Modifier-Projet.php?id=<?= $projet->getIdProjets() ?>" class="ms-4"><i
                                                    class="bi bi-pencil"></i></a></td>
                                        <td><a href="Supprimer-Projet.php?id=<?= $projet->getIdProjets() ?>"
